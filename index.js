// app.js
// Express + AWS Cognito with aws-jwt-verify
// Features: signup, confirm, signin, refresh, role-based access via Cognito Groups (super-admin, admin, operator, technician)
// Requires: Node 18+
